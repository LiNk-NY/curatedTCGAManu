...
```{r}
brca2 <- brca1[, , c("BRCA_RNASeq2GeneNorm-20160128_ranged", "has.meth", "mutations")]
brca3 <- MatchedAssayExperiment(brca3)
keep <- assay(brca3, "ACC_RNASeq2GeneNorm-20160128_ranged") > 3 &
  assay(brca3, "has.meth_ranged") &
