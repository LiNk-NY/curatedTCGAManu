...
#    res = 600)
svg("PANCAN_Mutations-oncoprint.svg", width = 12, height = 8)

ComplexHeatmap::oncoPrint(
    list_mats3, alter_fun = mutfuns2, col = colors, show_pct = FALSE, use_raster = FALSE
)
dev.off()
```
...
svg("Mutations-oncoprint.svg", width = 12, height = 8, units = "in")
