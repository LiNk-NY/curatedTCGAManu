...
load("~/data/primarypancanmutations.rda")
```
...
save(list_mats2, file = "list_mats2.rda")
save(mutfuns2, file = "mutfuns2.rda")

ComplexHeatmap::oncoPrint(
    list_mats2, alter_fun = mutfuns2, col = colors, show_pct = FALSE
)
```
